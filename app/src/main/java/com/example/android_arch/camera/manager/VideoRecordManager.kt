package com.example.android_arch.camera.manager

import android.content.Context
import android.media.MediaRecorder
import com.example.android_arch.camera.util.FileUtil
import com.example.android_arch.camera.widget.VideoRecord


class VideoRecordManager(private val videoRecord: VideoRecord, val context: Context) {
    ...
    fun start() {
        ...
        //设置输出的文件路径
        mRecorder!!.setOutputFile(FileUtil.getVideoSavePath(context))
        //预处理
        mRecorder!!.prepare()
        //开始录制
        mRecorder!!.start()
