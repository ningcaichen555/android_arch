...
class ButternKnifeFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fragmentManager.beginTransaction().add(R.id.test_layout, BlankFragment())
    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_buttern_knife, container, false)
    }
